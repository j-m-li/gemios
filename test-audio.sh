...
# 3. Play tone (440Hz 200ms)
send_cmd('audio tone 440 200')

# 4. Play beep (880Hz 150ms)
send_cmd('beep 880 150')

# 5. List files and play WAV audio file from FAT32 filesystem
send_cmd('ls')
...
if grep -q "Playing 440 Hz tone" "$SERIAL_LOG"; then
